...
api_data = dict(
    ...
    api_key=os.getenv("OPENAI_API_KEY","sk-tysxceqvlzddeysjqmdrfwlkbwazwnmibzhysjlghknvytqs"),
    )
...
async def entrypoint(ctx: JobContext):
    ...
    tts_model = openai.TTS(model='fnlp/MOSS-TTSD-v0.5', voice='speech:wanghappy-10s_2:d405nbh719ns73fh1p2g:gjliizddctxhsptbuoux', **api_data)
    ...
    assistant = VoicePipelineAgent(
        ...
        llm=openai.LLM(model="deepseek-ai/DeepSeek-V3.2", temperature=0.8, **api_data),
        tts=tts_model,
        # tts= TTS(),
